            ...
            <div class="row row-cols-2 align-items-start">
                <div class="col">
                    <div class="card" class="" style="width: 18rem;" data-bs-theme="dark">
                        <img src="../img/zimmer1.gif" class="card-img-top" alt="Zimmer 1">
                        <div class="card-body">
                            <h5 class="card-title">Einzelzimmer mit<br>Einzelbett</h5>
                            <p class="card-text">30€ / Nacht</p>
                    ...
                    <div class="card" style="width: 18rem;" data-bs-theme="dark">
                        <img src="../img/zimmer3.gif" class="card-img-top" alt="Zimmer 2">
                        <div class="card-body">
                            <h5 class="card-title">Luxus Zimmer</h5>
                            <p class="card-text">200€ / Nacht<br>Bestellservice inkludiert<br>Jacuzzi im Zimmer</p>
                ...
                <div class="col">
                    <div class="card" style="width: 18rem;" data-bs-theme="dark">
                        <img src="../img/zimmer2.gif" class="card-img-top" alt="Zimmer 3">
                        <div class="card-body">
                    ...
                    <div class="card" style="width: 18rem;" data-bs-theme="dark">
                        <img src="../img/zimmer4.gif" class="card-img-top" alt="Zimmer 4">
                        <div class="card-body">
