      ...
      <div class="accordion-item">
        ...
        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show">
          <div class="accordion-body">
              <h3>Wie buche ich ein Zimmer?</h3>
                <p>Am einfachsten buchst du über unsere Webseite. Du kannst uns auch eine E-Mail an <a href="mailto:office@hoteltropicana.at">office@hoteltropicana.at</a> schreiben oder unter <a href="tel:+436604206969">+43 660 4206969</a> anrufen.</p>
              <h3>Welche Leistungen kann ich optional dazubuchen?</h3>
                <p>Frühstück, Parkplatz in unserer Tiefgarage und die Mitnahme von Haustieren kannst du dir optional dazubuchen.</p>
        ...
        <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse">
          <div class="accordion-body">
            ...
            <p>Bestenfalls fahren Sie mit der U3 bis zur Endstation Simmering, fahren mit dem 73A zur Station Florian-Hedorfer-Straße und gehen den Rest zu Fuß.</p>
            <h3>Wie weit ist der nächste Flughafen entfernt?</h3>
            <p>Wien-Schwechat - Der City Airport Train (CAT) fährt von der Station Wien Mitte alle 30 Minuten zum Flughafen.</p>
            <h3>Wie weit ist es zum nächsten Bahnhof?</h3>
            <p>Internationale Züge fahren vom Hauptbahnhof und Westbahnhof ab. Beide Bahnhöfe sind gut mit öffentlichen Verkehrsmitteln oder einer kurzen Taxifahrt erreichbar.</p>
          </div>
        </div>
      </div>
    </div> -->
